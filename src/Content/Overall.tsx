    ...
    useEffect(() => {
        ...
        getData<NationalData>(ApiList.NATIONAL_DATA).then(data => {
            if (mounted) {
                ...
                const _confirmedCases: any[] = [], _deaths: any[] = [], _recovered: any[] = [], _recoveryRate: any[] = [], _deathRate: any[] = [];
                let _totalConfirmedCases = 0, _totalDeaths = 0, _totalRecovered = 0, _totalRecoveryRate = 0, _totalDeathRate = 0;
                statewise.forEach(({ statecode, confirmed, deaths, recovered}) => {

...
export function States() {
    ...
    useEffect(() => {
        let _selectedState: string;
        getCurrentLocation().then((state) => {
    ...
    useEffect(() => {
        setLoading(true);
        Promise.all([getDistrictWiseData(), getZones()]).then(([stateData, zonesData]) => {
    ...
    return (
        <>
            ...
            <Grid container spacing={3}>
                ...
                <Grid item md={12} xs={12}>
                    <Paper className={classes.paper}>
                        <StateChart name="Confirmed cases" data={confirmed} loading={loading} />
                    </Paper>
                </Grid>
                <Grid item md={12} xs={12}>
                    <Paper className={classes.paper}>
                        <StateChart name="Active Cases" data={active} loading={loading} />
                    </Paper>
                </Grid>
                <Grid item md={12} xs={12}>
                    <Paper className={classes.paper}>
                        <StateChart name="Recovered" data={recovered} loading={loading} />
                    </Paper>
                </Grid>
                <Grid item md={12} xs={12}>
                    <Paper className={classes.paper}>
                        <StateChart name="Deaths" data={deceased} loading={loading} />
                    </Paper>
                </Grid>
            </Grid>
        </>
